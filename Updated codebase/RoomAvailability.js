                        ...
                        for (var index = 0; index < result1.length; index++) {
                            ...
                            if (start_diff == 0) {
                                ...
                                if (start_diff > 0 && mid_diff > 0) {
                                    //CASE 2 NOT AVAILABE(new meeting starts earlier than booked but ends after booked meeting has started)
                                    console.log("CASE 2: Sorry, room not available");
                                    avail = false;
                                    id = "";
                                    return resolve(avail);
                                } else if (start_diff > 0 && mid_diff < 0) {
                                    //CASE 3 AVAILABE(new meeting starts earlier than booked and ends before booked meeting has started)
                                ...
                                mid_diff = Math.floor(mid_diff / 60e3);
                                if (start_diff < 0 && mid_diff > 0) {
                                    //CASE 4 NOT AVAILABE(booked meeting starts earlier than new but ends after booked meeting has started)
                                    console.log("CASE 4: Sorry, room not available");
                                    avail = false;
                                    id = "";
                                    return resolve(avail);
                                } else if (start_diff < 0 && mid_diff < 0) {
                                    //CASE 5 AVAILABE(booked meeting starts earlier than new and ends before new meeting has started)
