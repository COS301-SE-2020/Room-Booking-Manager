...
module.exports = {
    ...
    {		var arr=[],arr2=[];
           ...
           // var attendeelocation=["1A1","1D1","1M1"];
            ...
            var hold;
            for(var n=0;n<Frooms.length;n++)//for converting feasible room ids to room name
            {
        ...
        arrayofAverageDistances=arrayofAverageDistances.sort(function(a, b){return a-b});//for sorting
        
        var bool=false,f,sorted=[];//sorted will contain sorted names with distances
